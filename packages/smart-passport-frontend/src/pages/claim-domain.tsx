...
import ENSButton from "src/components/action-buttons/connect-wallet/ENS";
import CoinbaseDomainButton from "src/components/action-buttons/connect-wallet/CoinbaseDomain";
          ...
          <div className="flex items-center container mx-auto">
            <div className="flex items-center flex-grow">
              <a href="/" className="flex justify-center gap-2">
                <img src={"/images/smart-passport.png"} style={{ height: 48 }} />
              </a>
            </div>
            <ConnectWallet />
          </div>
            ...
            <div className="container mx-auto flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                <h1 className="text-3xl font-semibold text-[#101828]">
                  Coinbase Smart Passport
                </h1>
                <h5 className="text-sm font-normal mt-1 text-[#344054] mb-5">
                  Connect Trusted Identities to Coinbase Smart Wallet
                </h5>
                <div className="flex flex-col gap-6">
                  ...
                  <div className="">
                    <Accordion
                      title="Link Domains"
                      subtitle="Link ENS and cb.id domains to Smart Wallet"
                      number="1"
                    >
                      <ENSButton
                        opAmount={0}
                  ...
                  <div className="">
                    <Accordion
                      title="Link Passport"
                      subtitle="Elevate your Smart Wallet's trust score"
                      number="2"
                    >
                      <GitcoinPassport
                        opAmount={0}
                  ...
                  <Accordion
                    ...
                    subtitle={"Link your social accounts to Smart Wallet"}
                    number="3"
                  >
