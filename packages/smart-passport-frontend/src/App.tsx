...
import RegisterFirstDomain from "./components/domain/RegisterFirstDomain";
import ReferralLink from "./components/marketing/ReferralLink";
import RetroPGF3TaskCard from "./components/retropgf3/RetroPGF3TaskCard";
import useAccountSiwe from "./hooks/useAccountSiwe";
import { useDomainList } from "./hooks/useDomainList";
import { IS_DEV } from "./utils/env";
import useRedirectToClaim from "./hooks/useRedirectToClaim";
import { BlueCreateWalletButton } from "./components/action-buttons/connect-wallet/BlueCreateWalletButton";

function App() {
  const { address, isConnected, chain } = useAccountSiwe();
        ...
        <main className="w-full pt-24">
          ...
          <div className="container relative z-20 mx-auto grid grid-cols-1 gap-x-4 gap-y-20 py-16 lg:grid-cols-2 px-6">
            <div className="flex flex-col items-center justify-center text-center lg:items-start lg:text-left">
              ...
              <h2 className="mb-12 text-4xl font-bold text-amber-300 underline decoration-amber-200/30 xl:text-5xl">
                .town Domains
              </h2>
              <p className="text-md mb-10 font-medium text-gray-300 xl:text-lg">
                A domain name powered by{" "}
                <a
                  className="text-amber-300"
                  href="https://opti.domains"
                  target="_blank"
                >
                  Opti.Domains
                </a>{" "}
                to be used in Bored Town ecosystems. Mainly for NFT
                whitelisting, with the potential for additional use cases in the
                future.
              </p>
              <div className="flex flex-col items-center sm:space-x-4 space-y-4 sm:flex-row sm:space-y-0">
                ...
                <a
                  href="https://zonic.app/collection/boredtown"
                  target="_blank"
                >
                ...
                <div className="h-[15rem] w-[11rem] rounded-2xl bg-gray-900 shadow-xl xl:h-[23rem] xl:w-[18rem]">
                  <div className="relative h-[11rem] w-full xl:h-[18rem]">
                    ...
                    >
                      <img
                        alt="Top Card"
                        src="/images/boredtown.gif"
                        decoding="async"
                        data-nimg="fill"
                        className="heroCard rounded-t-2xl"
                        style={{
                          position: "absolute",
                          top: 0,
                          left: 0,
              ...
              <div className="relative skew-y-3 -translate-x-20 animate-pulse -skew-x-6">
                <div className="h-[15rem] w-[11rem] rounded-2xl bg-gray-900 shadow-xl xl:h-[23rem] xl:w-[18rem]">
                  ...
                  <div className="flex h-[4rem] w-full items-center justify-end px-4 xl:h-[5rem]">
                    <div className="flex items-center space-x-3">
                      <div>
                        <p className="text-xs text-gray-300 xl:text-sm text-right">
                          Zkalien
                        </p>
                        <p className="text-md font-medium text-indigo-300 xl:text-xl">
                          zkalien.town
          ...
          {IS_COUNTDOWN ? (
            <div className="text-center text-2xl">
              Mainnet minting in a fews day!
            </div>
          ) : (
            <>
              {!address || !isConnected ? (
                <section
                  className="container relative z-10 mx-auto py-10 px-6"
                  id="retropgf3"
                >
                  <div className="flex flex-col justify-center items-center rounded-xl bg-red-950 p-4 shadow-lg glowing-btn glowing-red py-12">
                    <img
                      src={"/infinity-op-circle.png"}
                ...
                <>
                  {(domainListSameChain.length == 0 ||
                    ...
                    <section
                      ...
                      id="register-front"
                    >
                      <h3 className="mb-4 text-center text-3xl font-semibold underline decoration-amber-500/80 lg:text-left xl:text-4xl">
                        {editMode ? "Edit Records" : "Claim Domains"}
                      </h3>
                    ...
                    !editMode && (
                      ...
                      >
                        <div className="flex justify-between items-center mb-4">
                          <h3 className=" text-center text-3xl font-semibold underline decoration-amber-500/80 lg:text-left xl:text-4xl">
                            My Domains
                          </h3>
                          <div
                            className="px-6 py-2 text-black bg-white rounded text-lg text-center transition-all hover:cursor-pointer hover:scale-105"
                            onClick={() => {
                              setEditMode(true);
                              message.info(
                                "Please reclaim your domain to edit records"
                              );
                              setTimeout(() => {
                                const registerFront =
                                  document.getElementById("register-front");
                                if (registerFront) {
                                  window.scrollTo({
                                    top:
                                      registerFront.getBoundingClientRect()
                                        .top +
                                      window.pageYOffset -
                                      50,
                                    behavior: "smooth",
                        ...
                        <div className="mt-8">
                          <ReferralLink domainList={domainList} />
                        </div>
          ...
          <section
            id="roadmap"
            className="container relative mx-auto py-12 px-6"
          >
            <h3 className="mb-8 text-center text-3xl font-semibold underline decoration-amber-500/80 lg:text-left xl:text-4xl">
              Use Cases
            </h3>
            <div className="relative flex flex-col">
              ...
              <div className="my-3 flex flex-col items-center space-x-4 space-y-4 rounded-xl bg-red-950 px-4 py-6 shadow-lg transition duration-300 hover:shadow-2xl lg:flex-row">
                <div className="z-50 rounded-full bg-amber-600 px-6 text-xl font-semibold shadow-md shadow-amber-500/30">
                  <span>1</span>
                </div>
                <div>
                  ...
                  <p className="text-center text-gray-300 lg:text-left">
                    Eligibility for whitelisting not only Bored Town's official
                    NFTs but also those created by Bored Town partnered artists
              ...
              <div className="my-3 flex flex-col items-center space-x-4 space-y-4 rounded-xl bg-red-950 px-4 py-6 shadow-lg transition duration-300 hover:shadow-2xl lg:flex-row">
                ...
                <div>
                  <h3 className="mb-2 text-center text-2xl font-semibold lg:text-left">
                    Optimism Attestation
                  </h3>
                  <p className="text-center text-gray-300 lg:text-left">
                    Attest your wallet and social links associated with your
                    domain name, along with your Bored Town activities, to the
                    official Optimism attestation contract. This will not only
                    serve as a record of your activity but also increase your
                    chances of receiving the{" "}
                    <span className="text-amber-300">OP airdrop</span>.
                  </p>
                </div>
              </div>
              <div className="my-3 flex flex-col items-center space-x-4 space-y-4 rounded-xl bg-red-950 px-4 py-6 shadow-lg transition duration-300 hover:shadow-2xl lg:flex-row">
                ...
                <div>
                  ...
                  <p className="text-center text-gray-300 lg:text-left">
                    By associating your wallet address into a single domain, you
                    can bid farewell to the inconvenience of using long,
                    unreadable wallet addresses that vary across different
                    blockchain networks.
                  </p>
                </div>
              </div>
