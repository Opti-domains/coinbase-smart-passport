...
function CoinbaseDomainButtonUnstyled(props: any) {
    ...
    <div {...props}>
      <div className="flex justify-between items-center mt-8">
        <div className="flex gap-2 w-64">
          <div>
            <img src="/images/cbwallet.png" className="w-10 h-10 rounded-full" alt="" />
          </div>
          <div>
            <div className="flex gap-2 items-center">
              <div className="font-medium text-[#101828]">Coinbase ID</div>
              {walletState && (
                <div>
                  <svg
            ...
            <div className="mt-1 text-[#667085] text-xs">
              {walletState
                ? `Linked as: ${walletState.displayName}`
      ...
      <StyleProvider hashPriority="high">
        <Modal
          ...
          onOk={() => handleSignMsg()}
        >
          <div className="mb-2 text-black">Please enter your cb.id domains</div>
          <Input
            value={walletAddress}
            onChange={(e) => setWalletAddress(e.target.value)}
            placeholder="chomtana.cb.id"
          />
        </Modal>
      </StyleProvider>
    </div>
...
export default styled(CoinbaseDomainButtonUnstyled)`
  .ant-menu {
