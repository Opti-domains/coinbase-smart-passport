        ...
        <div className="flex gap-2 w-64">
          ...
          <div>
            ...
            <div className="mt-1 text-[#667085] text-xs">
              {walletState
                ? `Linked as: ${walletState.displayName.substr(0, 16)}...`
                : "Not linked"}
            </div>
          </div>
        </div>
      ...
      <StyleProvider hashPriority="high">
        ...
        >
          ...
          <Input
            ...
            placeholder="opkit1g2hrwevvqnm0mcux859mmzcznevx3wh6yvprux"
          />
        </Modal>
      </StyleProvider>
    </div>
