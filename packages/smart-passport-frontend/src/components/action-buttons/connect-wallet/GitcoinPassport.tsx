...
function GitcoinPassportButtonUnstyled(props: any) {
    ...
    <div {...props}>
      <div className="flex justify-between items-center mt-8">
        <div className="flex gap-2 w-64">
          <div>
            <img src="/images/gitcoinpassport.jpg" className="w-10 h-10 rounded-full" alt="" />
          </div>
          <div>
            <div className="flex gap-2 items-center">
              <div className="font-medium text-[#101828]">Gitcoin Passport</div>
              {walletState && (
                <div>
                  <svg
      ...
      <StyleProvider hashPriority="high">
        <Modal
          title={"Link Gitcoin Passport"}
          open={walletSelectorModalOpen}
          confirmLoading={submitting}
          onCancel={() => setWalletSelectorModalOpen(false)}
          onOk={() => handleSignMsg()}
        >
          <div className="mb-2 text-black">Please enter your wallet having Gitcoin Passport score</div>
          <Input
            value={walletAddress}
...
export default styled(GitcoinPassportButtonUnstyled)`
  .ant-menu {
