...
export default function FreedomWalletButton({ variant = "button" }) {
  ...
  async function handleSignMsg() {
    ...
    try {
      ...
      const response = await axios.post(import.meta.env.VITE_SOCIAL_ORACLE_ENDPOINT + '/wallet/freedom-wallet/verify', {
        domainName,
        walletAddress,
        timestamp,
        signature: '0x',
  ...
  return (
    <>
      <ActionButton
        ...
        variant={variant}
      >
        {walletState ? addressEllipsis(walletState.displayName) : "Freedom Wallet"}
      </ActionButton>
      ...
      <StyleProvider hashPriority="high">
        ...
        >
          ...
          <div>Follow this guideline to obtain your Freedom Wallet address:</div>
          ...
          <ol className="list-decimal pl-6">
            ...
            <li>Copy your wallet address shown next to your name and avatar.</li>
