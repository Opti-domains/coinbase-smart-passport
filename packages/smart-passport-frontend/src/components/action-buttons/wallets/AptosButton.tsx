...
function AptosButtonUnstyled(props: any) {
  ...
  return (
    <div {...props}>
      <ActionButton color="white" background="black" icon={aptosIcon} checked={!!walletState} onClick={() => onWalletButtonClick()} variant={props.variant}>
        {walletState ? addressEllipsis(walletState.displayName) : "Aptos"}
      </ActionButton>
